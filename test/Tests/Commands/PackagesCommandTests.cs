...
public class PackagesCommandTests
{
    ...
    public async Task Should_PackagesCommand_Return_Ok(string schemaName, string filterKeyword, int maxItems)
    {
        // arrange
    ...
    public async Task Should_PackagesCommand_Return_Ko(string schemaName, string filterKeyword, int maxItems)
    {
        // arrange
        var connectionString = _oracleFixture.ConnectionString;
