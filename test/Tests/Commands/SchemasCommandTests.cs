...
{
    [Fact]
    public async Task Should_SchemasCommand_Return_Ok()
    {
        // arrange
    ...
    [Fact]
    public async Task Should_SchemasCommand_Return_Also_Ok()
    {
        // arrange
        var app = new CommandLineApplication();
        var consoleService = Substitute.For<IConsoleService>();
    ...
    [Fact]
    public async Task Should_SchemasCommand_Return_Ko()
    {
        // arrange
        var app = new CommandLineApplication();
        var consoleService = Substitute.For<IConsoleService>();
