...
public class ObjectsCommandTests
{
    ...
    public async Task Should_ObjectsCommand_Return_Ok(string ownerName, string filterKeyword, int maxItems)
    {
        // arrange
    ...
    public async Task Should_ObjectsCommand_Return_Ko(string ownerName, string filterKeyword, int maxItems)
    {
        // arrange
        var connectionString = _oracleFixture.ConnectionString;
